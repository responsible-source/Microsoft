      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className="bg-white w-[300px] h-[350px] md:w-[400px] md:h-[350px] shadow-2xl px-6">
            <form action="#" className="flex flex-col py-8 px-4">
                ...
                <div className="mt-3">
                    {value.email === "" ? <p className="text-red-500 text-[14px]">{errors.value}</p>:<p className="text-red-500 text-[14px]">{errors.email}</p>}
                    <input
                     type="text" 
                     name="email" 
                     value={value.email} 
                ...
                <div className="mt-3">
                <Link href='/' className="text-[12px] text-blue-400">Can't access your account?</Link>
                </div>

                <div className="flex justify-end mt-3">
                    <button onClick={handleClick} className="bg-[#0067B8] hover:bg-[#022B57] text-white py-1 px-8"
                    >Next</button>
                </div>
            </form>
        </div>
